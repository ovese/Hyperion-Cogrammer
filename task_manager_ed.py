...
I have also used tabulate to display tyhe applications 
...
class TaskManager():
    ...
    9. validate_user_entry which ensures entered user name is found in retirved saved users
    ...
    16. exit function which helps user leave the program
    ...
    def add_task(self, auth_dict, task_list):
        ...
        # lets get the current user from the dictionary passed as argument
        # curr_user = {k : v for (k,v) in username_password.items()} # dictionary comprehension
        # print(curr_user)
