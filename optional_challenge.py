...
# the list below has contents firstname,
# last name, age, street, postcoe and city
...
print(new_list)
# i have tried creating new list and assigning
# an expanded original list to it wrongly
...
for i in another_list:
    print(item)
    # another logical error printing the
    # wrong variable item instead of i
