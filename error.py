...
years_from_now = "3"
int_years_from_now = int(years_from_now)
print(">>>Fixed another indentationError on line 24")
total_years = age + years_from_now
number_total_years = int_age + int_years_from_now
...
total_months = number_total_years * 12
